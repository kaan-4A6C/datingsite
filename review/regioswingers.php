...
<head>
  ...
  <link rel="stylesheet" href="background/regioswingers/regioswingers.css">
  <title>Regioswingers</title>
  <!--
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 col-sm-12">
          ...
          <a href="http://tc.tradetracker.net/?c=6823&amp;m=224966&amp;a=288654&amp;r=&amp;u=" class="smoothScroll btn btn-default">schrijf je nu in!</a>
        </div>
      </div>
    </div>
  </section>
  ...
  <div class="container text-center">
    ...
    <div class="text-center tekst-size">
        <?php
            ...
            $query = "SELECT AVG(rating) / 10 as 'avg' FROM reviews WHERE dating_site_id = 24";
    ...
    <?php
            $stars =  '<div class="row flex">
                 ...
                 $query = "SELECT * FROM reviews WHERE dating_site_id = 24 AND ip = '$ip'";
