...
<head>
  ...
  <link rel="stylesheet" href="background/metjou/metjou.css">
  <title>Metjou.nl</title>
   <!--
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 col-sm-12">
          ...
          <a href="http://tc.tradetracker.net/?c=982&amp;m=21562&amp;a=288654&amp;r=&amp;u=" class="smoothScroll btn btn-default">schrijf je nu in!</a>
        </div>
      </div>
    </div>
  </section>
  ...
  <div class="container text-center">
    ...
    <div class="text-center">
        <?php
            ...
            $query = "SELECT AVG(rating) / 10 as 'avg' FROM reviews WHERE dating_site_id = 16";
    ...
    <?php
            $stars =  '<div class="row flex">
                 ...
                 $query = "SELECT * FROM reviews WHERE dating_site_id = 16 AND ip = '$ip'";
