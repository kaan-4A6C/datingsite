...
<head>
  ...
  <link rel="stylesheet" href="background/vijftigplusdating/vijftigplusdating.css">
  <title>Vijftigplusdating</title>
  <!--
...
<body>
  ...
  <div class="container text-center">
    ...
    <div class="text-center">
        <?php
            $db = new mysqli("46.105.68.243", "flirtjessgidssen ", "Ojo07y8malf_MrvM", "dbbb_flirtjessgidss");


            $query = "SELECT AVG(rating) / 10 as 'avg' FROM reviews WHERE dating_site_id = 39";
    ...
    <?php
            $stars =  '<div class="row flex">
                 ...
                 $query = "SELECT * FROM reviews WHERE dating_site_id = 39 AND ip = '$ip'";
