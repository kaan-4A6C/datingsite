...
<head>
  ...
  <link rel="stylesheet" href="background/piratendating/piratendating.css">
  <title>Piratendating</title>
  <!--
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 col-sm-12">
          ...
          <a href="http://tc.tradetracker.net/?c=24045&amp;m=1036507&amp;a=288654&amp;r=&amp;u=" class="smoothScroll btn btn-default">schrijf je nu in!</a>
        </div>
      </div>
    </div>
  </section>
  ...
  <div class="container text-center">
    ...
    <?php
            $stars =  '<div class="row flex">
                 ...
                 $query = "SELECT * FROM reviews WHERE dating_site_id = 22 AND ip = '$ip'";
