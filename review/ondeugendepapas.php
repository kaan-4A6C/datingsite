    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 col-sm-12">
          <h1>Ondeugende-Papas</h1>
          <!-- <h4>lorem ipsum en nog iets extra want anders word het te kort</h4> -->
          <a href="http://tc.tradetracker.net/?c=24051&amp;m=1036567&amp;a=288654&amp;r=&amp;u=" class="smoothScroll btn btn-default">schrijf je nu in!</a>
        </div>
      </div>
    </div>
  </section>
  ...
  <div class="container text-center">
    ...
    <div class="text-center tekst-size">
        <?php
            ...
            $query = "SELECT AVG(rating) / 10 as 'avg' FROM reviews WHERE dating_site_id = 21";
    ...
    <?php
            $stars =  '<div class="row flex">
                 ...
                 $query = "SELECT * FROM reviews WHERE dating_site_id = 21 AND ip = '$ip'";
