...
<head>
  ...
  <link rel="stylesheet" href="background/adultmatch/adultmatch.css">
  <title>Adultmatch</title>
  <!--
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 col-sm-12">
          ...
          <a href="http://www.adultmatch.nl/dating/?tt=3985_154098_288654_&amp;r=" class="smoothScroll btn btn-default">schrijf je nu in!</a>
        </div>
      </div>
    </div>
  </section>
...
<div class="panel panel-default tableStyle" style="position:frelative">
  ...
  <div class="container text-center">
    ...
    <div class="text-center">
        <?php
            ...
            $query = "SELECT AVG(rating) / 10 as 'avg' FROM reviews WHERE dating_site_id = 41";
    ...
    <?php
            $stars =  '<div class="row flex">
                 ...
                 $query = "SELECT * FROM reviews WHERE dating_site_id = 41 AND ip = '$ip'";
